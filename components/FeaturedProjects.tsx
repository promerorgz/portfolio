  ...
  return (
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.h2 variants={fadeIn} className="text-3xl font-bold text-foreground sm:text-4xl">
          ...
          {featuredProjects.map((project, index) => (
            ...
            >
              <div className="relative h-48 w-full">
                <div className={`absolute inset-0 ${styles.overlay} z-10`}></div>
                <Image
                  src={project.image}
                  alt={project.name}
                  fill
        ...
        >
          <Link href="/projects" passHref>
            <Button className={`${styles.button} text-white px-6 py-3 rounded-md`}>
              View All Projects
